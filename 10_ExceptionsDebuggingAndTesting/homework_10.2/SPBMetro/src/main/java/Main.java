...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (; ; ) {
            ...
            try {
                ...
                logger.error("Ошибка получения станции/времени в пути: " + getRouteCalculator(), ex);
            }
        }
    }
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                logger.info("Станция: " + line + " - станция найдена!");
                return station;
            }
            logger.warn("Станция: " + line + " - введена не верно");
